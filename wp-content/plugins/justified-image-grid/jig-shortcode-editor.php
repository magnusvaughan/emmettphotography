		...
		<div id="jig-sc-editor" style="display:none;">
			<form action="/" method="get" accept-charset="utf-8">
				...
				<div id="jig_lightboxes_tab_content" class="jigSettingsTab jig_settings_group clearfix">
					...
					<div class="row generalDashedRow">
						<div class="longHelp"><?php _e('Custom lightbox', 'jig_td'); ?></div>
					</div>
					<div class="row">
				...
				<div class="jigSettingsTab jig_settings_group_flickr clearfix" id="flickr">
					...
					<div class="row">
						...
						<div class="minihelp"><?php _e('Show title of current Flickr collections or photoset and a link back to all parents in the hierarchy. This is only used when a collection is selected for display.', 'jig_td'); ?></div>
					</div>
					<div class="row">
						<div class="normalname"><?php _e('Separator character', 'jig_td'); ?></div>
							...
							switch(domain){
								case 'youtube':
									...
									if (youtubeMatch != null) {
										feedUrl = "http://gdata.youtube.com/feeds/base/users/"+youtubeMatch[1]+"/uploads?max-results=50";
									}
